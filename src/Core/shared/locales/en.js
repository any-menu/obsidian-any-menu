...
!!! Note: Most of the settings in the current settings panel will take effect only after a restart (for plugin usage, the plugin needs to be restarted; for software version usage, the software needs to be restarted).
`,
